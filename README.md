...
Submit a patch that works and I'll donate to your favorite charity. I mean it. I don't know how much. ~~Two hundred dollars?~~ ~~(**Update**: [now $400](https://github.com/nadimkobeissi/16iax10h-linux-sound-saga/issues/1))~~ (**Update**: [now $500](https://github.com/nadimkobeissi/16iax10h-linux-sound-saga/issues/2)) I'm not exactly drowning in money. I can help you test via my hardware.
